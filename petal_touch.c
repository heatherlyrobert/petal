...
TOUCH_open         (void)
{
   ...
   /*---(open)---------------------------*/
   DEBUG_TOUCH  yLOG_info    ("name"      , my.name_event);
   my.file_event = fopen (my.name_event, "r");
   DEBUG_TOUCH  yLOG_point   ("*file"     , my.file_event);
   --rce;  if (my.file_event == NULL) {
